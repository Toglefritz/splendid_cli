    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            // Lamp icon that changes appearance based on state. When the lamp
            // is on, it displays a bright yellow bulb with glow effect. When
            // off, it displays a dim gray bulb without glow.
            Container(
              width: 120,
              height: 120,
