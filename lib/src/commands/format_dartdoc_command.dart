...
/// special formatting elements like code blocks, lists, and headers.
///
/// Key Features:
...
class FormatDartdocCommand extends Command<int> {
  /// Creates a new instance of [FormatDartdocCommand] with configured argument
  /// parser.
  ///
  ...
  /// Executes the Dartdoc formatting command with parsed command-line
  /// arguments.
  ///
  ...
  Future<int> run() async {
    ...
    try {
      ...
      ///
      /// Encapsulates the business logic for Dartdoc comment processing and
