...
///
/// This service implements a hybrid approach that prioritizes local bricks
...
class BrickLoader {
  ...
  ///
  /// Downloaded bricks are cached here to avoid repeated downloads and
  /// to work offline after the first download.
  ...
  ///
  /// This method knows the specific structure of the flutter_screen brick
  /// and downloads all necessary template files.
  ...
  ///
  /// This method removes all cached bricks, forcing fresh downloads
  /// on the next brick load. Useful for development and troubleshooting.
