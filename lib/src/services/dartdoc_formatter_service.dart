...
///
/// This service handles the business logic for processing Dartdoc comments, including line length adjustment, proper
...
class DartdocFormatterService {
  ...
  ///
  /// This method processes the specified target (file or directory) and reformats all Dartdoc comments according to the
  ...
  ///
  /// Reads the file content, identifies and reformats Dartdoc comments, and writes the updated content back to the file
  ...
  ///
  /// This method processes the entire file content and reformats all Dartdoc comments according to the specified line
  ...
  ///
  /// Recognizes both /// and /** comment styles, accounting for leading whitespace that should be preserved.
  ...
  ///
  /// Identifies the full extent of a Dartdoc comment, handling both single-line (///) and multi-line (/** */) comment
  /// styles.
  ...
  ///
  /// Handles the special formatting requirements of multi-line comments, including proper * alignment and content
  /// wrapping.
  ...
  ///
  /// Handles the wrapping and reformatting of triple-slash comments while maintaining proper indentation and comment
  /// syntax.
...
///
/// This class encapsulates the structure and metadata of a comment block, including its content, formatting style, and
/// positioning information needed for proper reformatting.
class DartdocBlock {
...
class DartdocFormatterResult {
  ...
  ///
  /// Subset of processedFiles that contained Dartdoc comments requiring reformatting according to the specified
  /// criteria.
  final List<String> modifiedFiles;
