...
///
/// This module contains the error type enumeration for screen service operations
/// within the Flutter screen generation service. It defines the specific categories
/// of errors that can occur during screen creation processes.
///
/// Key Components:
...
enum ScreenServiceErrorType {
  ...
  ///
  /// Recovery: Prompt the user to provide a valid screen name that follows
  /// Dart identifier naming conventions (alphanumeric and underscore only,
  /// starting with letter or underscore).
  invalidScreenName,

  /// Directory is not a Flutter project.
  ///
  /// This error occurs when the specified project path does not contain
  /// the required files and structure of a Flutter project. The service
  /// validates for:
  /// * Presence of pubspec.yaml file
  /// * Presence of lib/ directory
  /// * Flutter dependencies in pubspec.yaml
  ///
  /// Recovery: Guide the user to navigate to a valid Flutter project
  /// directory or initialize a new Flutter project in the current location.
  notFlutterProject,

  /// Screen already exists.
  ///
  /// This error occurs when screen files with the requested name already
  /// exist in the project and the force flag is not set. The service
  /// detects existing screen directories and files to prevent accidental
  /// overwrites.
  ///
  ...
  ///
  /// This error type covers unexpected failures that don't fit into the
  /// other specific categories. Common scenarios include:
