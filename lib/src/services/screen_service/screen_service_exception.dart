...
/// within the Flutter screen generation service. It provides structured error
/// handling with specific error types and diagnostic information.
///
/// Key Components:
...
/// operations, including specific error types, human-readable messages, and
/// optional underlying cause information for debugging purposes.
///
...
class ScreenServiceException implements Exception {
  ...
  /// template processing failures), the original exception is preserved here
  /// for debugging and logging purposes.
  ///
  /// This field is null when the error originates directly from screen service
  /// validation logic rather than underlying system operations.
  final Object? cause;

  /// Returns a string representation of this exception.
  ///
  /// The string includes the exception class name and the human-readable error
