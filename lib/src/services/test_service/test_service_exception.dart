...
///
/// This module contains the exception class for test service operations.
/// It provides structured error handling with specific error types and
...
///
/// This exception class provides structured error handling for all test
/// service operations. It includes a human-readable message, a specific
/// error type for programmatic handling, and optional cause information
/// for debugging purposes.
///
/// The exception is designed to provide clear feedback to both users and
/// developers about what went wrong during test generation operations,
...
class TestServiceException implements Exception {
  ...
  ///
  /// This enumeration value allows for programmatic handling of different
  /// error scenarios. Callers can use this to implement specific recovery
  /// strategies or user interface behaviors based on the error type.
  final TestServiceErrorType type;

  /// Optional underlying cause.
  ///
  /// When this exception wraps another exception (such as file system
  /// errors or template generation failures), the original exception
