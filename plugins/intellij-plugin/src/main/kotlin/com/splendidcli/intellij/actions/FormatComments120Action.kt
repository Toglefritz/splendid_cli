...
/**
 * Action to format regular comments in Dart files to 120 character line length.
 * 
 ...
 */
class FormatComments120Action : AnAction() {
    ...
    /**
     * Executes the format-comments command on the selected Dart file with 120 character line length.
     * 
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        ProgressManager.getInstance().run(object : Task.Backgroundable(
            project,
            "Formatting Regular Comments (120 chars)",
            false
        ) {
                    ...
                    if (result.isSuccess) {
                        ...
                        if (settings.showSuccessNotifications) {
                            cliExecutor.showNotification(
                                "Format Successful",
                                "Regular comments in ${file.name} formatted to 120 characters",
