...
/**
 * Action to fully format Dart files including comments and code with 80 character line length.
 * 
 ...
 * command with a line length of 80 characters on the selected file, which performs:
 ...
 */
class FormatDartFile80Action : AnAction() {
    ...
    /**
     * Executes the format command on the selected Dart file with 80 character line length.
     * 
                    ...
                    if (result.isSuccess) {
                        ...
                        if (settings.showSuccessNotifications) {
                            cliExecutor.showNotification(
                                "Format Successful",
                                "${file.name} fully formatted to 80 characters",
