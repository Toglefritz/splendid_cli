...
/**
 * Action to format Dartdoc comments in Dart files to 120 character line length.
 * 
 * This action appears in the context menu when right-clicking .dart files
 * in the editor or project view. It executes the `splendid_cli format-dartdoc`
 * command with a line length of 120 characters on the selected file.
 * 
 ...
 */
class FormatDartdoc120Action : AnAction() {
    ...
    /**
     * Executes the format-dartdoc command on the selected Dart file with 120 character line length.
     * 
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        ProgressManager.getInstance().run(object : Task.Backgroundable(
            project,
            "Formatting Dartdoc Comments (120 chars)",
            false
        ) {
            override fun run(indicator: ProgressIndicator) {
                indicator.text = "Running splendid_cli format-dartdoc on ${file.name}..."
                    ...
                    if (result.isSuccess) {
                        ...
                        if (settings.showSuccessNotifications) {
                            cliExecutor.showNotification(
                                "Format Successful",
                                "Dartdoc comments in ${file.name} formatted to 120 characters",
