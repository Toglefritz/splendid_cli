...
/**
 * Action to format Dartdoc comments in Dart files to 80 character line length.
 * 
 ...
 */
class FormatDartdoc80Action : AnAction() {
    ...
    /**
     * Executes the format-dartdoc command on the selected Dart file with 80 character line length.
     * 
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        ProgressManager.getInstance().run(object : Task.Backgroundable(
            project,
            "Formatting Dartdoc Comments (80 chars)",
            false
        ) {
                    ...
                    if (result.isSuccess) {
                        ...
                        if (settings.showSuccessNotifications) {
                            cliExecutor.showNotification(
                                "Format Successful",
                                "Dartdoc comments in ${file.name} formatted to 80 characters",
