...
///
/// This class provides utilities for cleaning up directories and files that
/// may be created during test execution, particularly when tests run CLI
/// commands that create projects or other artifacts at the root level.
class ProjectCleanupHelper {
  /// List of directory names that should be cleaned up after tests.
  ///
  /// These are common directory names that tests might create when running
  /// CLI commands or testing project creation functionality.
  ...
  ///
  /// This method removes any directories that may have been created during
  /// test execution. It's designed to be safe to call even if the directories
  /// don't exist, and it handles errors gracefully to prevent test failures
  /// due to cleanup issues.
  ///
  /// This method should be called in `tearDownAll` or similar cleanup hooks
  /// to ensure test artifacts don't accumulate on the file system.
  ...
  /// directory. It's useful for cleaning up directories with dynamic names
  /// or for targeted cleanup in specific tests.
  ///
  /// Parameters:
  ...
  ///
  /// This method removes all directories in the current working directory
  /// that match the specified pattern. It's useful for cleaning up directories
  /// with generated names or prefixes.
  ///
  /// Parameters:
  ...
  ///
  /// This method can be used to verify that cleanup is working correctly
  /// or to warn about leftover test artifacts.
  ///
  /// Returns:
