...
/// Integration tests that actually run Flutter commands are in the integration
/// test suite to avoid dependencies on Flutter SDK in unit tests.
void main() {
  group('SetupCommand', () {
    ...
    ///
    /// Creates fresh instances for each test to ensure isolation and prevent
    /// test interference.
    setUp(() {
    ...
    ///
    /// Ensures no test artifacts are left behind that could affect subsequent
    /// tests or consume disk space.
    tearDown(() {
    ...
    group('Flutter project detection', () {
      ...
      ///
      /// Creates a minimal Flutter project structure and verifies that the
      /// command correctly identifies it as a valid project.
      ...
      ///
      /// Verifies that the command correctly identifies directories that are
      /// not Flutter projects when pubspec.yaml is missing.
      ...
      ///
      /// Verifies that the command correctly identifies directories that are
      /// not Flutter projects when the lib directory is missing.
...
''',
      ...
      ///
      /// Verifies that the command correctly identifies Dart projects that are
      /// not Flutter projects (missing Flutter SDK dependency).
...
///
/// This helper function creates the minimum files and directories needed for a
/// directory to be recognized as a valid Flutter project:
