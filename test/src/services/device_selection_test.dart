...
///
/// This test suite verifies the device selection logic in ProjectService,
/// ensuring that the system correctly handles multiple devices, selects
/// appropriate defaults, and respects user-specified device preferences.
///
/// Test Categories:
...
void main() {
  group('Flutter Device Selection', () {
    group('FlutterDevice', () {
      /// Tests that FlutterDevice correctly parses JSON from flutter devices
      /// --machine.
      ///
      /// This test verifies that the FlutterDevice.fromJson factory constructor
      /// properly handles the JSON format returned by the Flutter CLI,
      ...
      ///
      /// This test ensures that the device parsing is robust and can handle
      /// JSON responses that may not include all optional fields, providing
      /// sensible defaults.
      ...
      /// Tests that FlutterDevice provides fallback values for completely
      /// missing fields.
      ///
      /// This test verifies that even with malformed or incomplete JSON, the
      /// device object can still be created with reasonable default values to
      /// prevent crashes.
      ...
      ///
      /// This test verifies the toJson method works correctly and produces the
      /// expected JSON structure, which is useful for debugging and logging
      /// purposes.
    ...
    group('Device Selection Priority', () {
      ...
      ///
      /// This test verifies that when multiple devices are available, the
      /// system correctly identifies and prioritizes desktop devices (Windows,
      /// macOS, Linux) as they are typically better for development.
      ...
      ///
      /// This test verifies that when no desktop devices are available, web
      /// browsers are selected over mobile devices due to their universal
      ...
      /// Tests that mobile devices are selected when no desktop or web devices
      /// are available.
      ///
      /// This test ensures that the system gracefully falls back to mobile
      /// devices when they are the only available option, maintaining
    ...
    group('Device Type Detection', () {
      /// Tests that desktop device detection works correctly for all desktop
      /// platforms.
      ///
      /// This test verifies that the system can correctly identify Windows,
      /// macOS, and Linux devices based on their target platform strings.
      ...
      ///
      /// This test verifies that the system can identify web browsers and
      /// web-based targets as web devices, distinguishing them from native
      ...
      /// Tests that mobile device detection works correctly for Android and
      /// iOS.
      ///
      /// This test verifies that the system can identify both physical devices
      /// and emulators for mobile platforms, handling various target platform
      /// string formats.
    ...
    group('Error Handling', () {
      ...
      ///
      /// This test verifies that the device type detection is robust and
      /// handles various edge cases like empty platform strings, unusual
      ...
      ///
      /// This test verifies that the FlutterDevice.fromJson method is robust
      /// and can handle various malformed or incomplete JSON inputs without
      /// crashing.
      ...
      ///
      /// This test verifies that a device cannot be classified as multiple
      /// types simultaneously and that the classification logic is consistent
